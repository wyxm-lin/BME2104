...
//             BME->robot[i].update(x, y, carry, status, frameID);
//         }
//         // Robots Data Update
...
//                     AstarTest(BME->robot, BME->atlas, 1.0, frameID);
//                     // AstarConsiderTime(BME->robot[i], BME->atlas, 1.0, frameID); // FIXME consider time not finished
